...
const handlePropertyTypeChange = () => {
  ...
  resetSelectOptions(accept_pets, [
  ...
  const steps = {
    ...
    2: {
      ...
      apply: () => {
        ...
        camp_price_range_rent.classList.toggle('form_disabled', intentValue !== 'rent');
        camp_price_range_sale.classList.toggle('form_disabled', intentValue !== 'sale');
        camp_accept_pets.classList.toggle('form_disabled', intentValue !== 'rent');
    ...
    3: {
      validate: () => {
        ...
        if (intentValue === 'rent') {
          ...
          delete formData.criteria.requiredAccepetsPets;
        }
